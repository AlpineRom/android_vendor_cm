...
PRODUCT_VERSION_MAINTENANCE = beta.02
...
ifeq ($(CM_BUILDTYPE), RELEASE)
    ...
    ifeq ($(PRODUCT_VERSION_MINOR),0)
        ...
        CM_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(PRODUCT_VERSION_MAINTENANCE)-$(shell date -u +%m%d%Y)$(CM_EXTRAVERSION)-$(CM_BUILD)
    endif
endif
